...
# 4. echo now serves the pinned import directly (ECHO-02 retired netbsdecho)
run_session "ECHO: pinned import serves /bin/echo after ECHO-02" \
'echo "=== echo ==="; echo hello world; echo -n hello; echo " post-n"; echo "=== multi -n flags ==="; echo -n -n foo; echo ""; echo "=== netbsdecho must be GONE ==="; netbsdecho hello; echo "status=$?"'
