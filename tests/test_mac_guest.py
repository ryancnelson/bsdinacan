...
class GuestTests(unittest.TestCase):
    ...
    def test_stage_records_complete_driver_transcript(self):
        ...
        self.assertEqual(sum(line.startswith('PASS ') for line in expected.splitlines()), 36)
        ...
        for probe in ['libcmemoryprobe', 'libcgetoptprobe E 1 0 -z', 'libctruncateprobe',
                      ...
                      'libcdirnameprobe', 'libcdirentprobe', 'dirname /tmp/example', 'dirname ////',
                      'dirname -- -leading/dash', 'dirname -x',
                      'dirname /a/b/c | cat', "dirname ''",
                      'libcbasenameprobe', 'basename /tmp/example.txt .txt',
