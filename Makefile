...
TEST_SOURCES := tests/libc_fwrite_compat_module.c tests/test_file.c tests/libc_file_probe_module.c tests/libc_file_compat_module.c tests/test_stdin.c tests/libc_stdin_probe_module.c tests/libc_stdin_compat_module.c tests/test_getopt_arg.c tests/libc_getopt_arg_probe_module.c tests/test_echo_state.c tests/test_argv.c tests/libc_argv_probe_module.c tests/test_stdio_state.c tests/libc_stdio_state_probe_module.c tests/test_fwrite.c tests/libc_fwrite_probe_module.c tests/libc_stdio_oldtable_probe_module.c tests/vfs_executable_probe.c tests/libc_progname_probe_module.c tests/test_core.c tests/test_locale.c tests/libc_locale_probe_module.c tests/test_terminal.c tests/libc_terminal_probe_module.c tests/libc_memory_probe_module.c tests/libc_exit_probe_module.c tests/libc_getopt_probe_module.c tests/libc_truncate_probe_module.c tests/libc_errx_probe_module.c tests/libc_err_probe_module.c tests/libc_warn_probe_module.c tests/libc_strcpy_probe_module.c tests/libc_dirname_probe_module.c tests/libc_dirent_probe_module.c tests/libc_basename_probe_module.c $(CORE_SOURCES)
...
$(BUILD)/libc_fwrite_probe.o: tests/libc_fwrite_probe.c include/cannedbsd/abi.h
	$(CC) $(CPPFLAGS) -Ilibc/include $(CFLAGS) -Dmain=cb_fwrite_probe_main -c tests/libc_fwrite_probe.c -o $@
$(BUILD)/libc_fwrite_wrapper_probe.o: tests/libc_fwrite_wrapper_probe.c include/cannedbsd/abi.h
